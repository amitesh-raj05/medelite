...
app.get(
  ...
  app.post('/submit', async (req, res) => {
      ...
      const UserEmail =1;
      try {
          const query = 'INSERT INTO user_info ( name, email, phone, city, project_name) VALUES ($1, $2, $3, $4, $5)';
          await db.query(query, [ name, UserEmail, phone, city, project_name]);
  ...
  app.get('/user-data', async (req, res) => {
    const userId = 1 // Assume user is logged in and req.user contains the user's info
    const UserEmail =1;
